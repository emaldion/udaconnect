# UdaConnect
The project aims at refactoring a flask application, analysing which message passing technique is best at some points and deploying the system to kubernetes. All technologies used are opensource.
